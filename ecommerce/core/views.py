...
from .models import Item, OrderItem, Order, Address, Payment, DiscountCode, Refund
from .forms import CheckoutForm, DiscountCodeForm, RefundForm
    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            if form.is_valid():
                ...
                #
                #     if is_valid_form([shipping_name, shipping_address1, shipping_country, shipping_state, shipping_zip]):
                ...
                #
                #     else:
                #         messages.info(self.request, 'Plz fill requied ship fields')
                #
                ...
                #
                #     if is_valid_form(
                #             [billing_name, billing_address1, billing_country, billing_state, billing_zip]):
                ...
                #
                #     else:
                #         messages.info(self.request, 'Plz fill requied bill fields')
                ...
                if same_billing_address:
                    ...
                    if is_valid_form([billing_name, billing_address1, billing_country, billing_state ,billing_zip]):
                        billing_address = Address(
                            user=self.request.user,
                            name=billing_name,
                            address_1=billing_address1,
